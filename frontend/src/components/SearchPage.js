      ...
      <div className="card-section" ref={sectionRef}>
        ...
        <div className="cards-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '0.7rem', gridAutoFlow: 'row' }}>
          {visibleCards.map((card, index) => {
            ...
            return (
              <div key={`${card.id || index}-${card.title}`} className="card-item" style={{ background: '#fff', border: '1px solid #eee', borderRadius: 7, boxShadow: '0 1px 4px rgba(0,0,0,0.03)', padding: '0.6rem 1.2rem', minWidth: 260, maxWidth: 300, fontSize: '0.97em', marginBottom: 0 }}>
