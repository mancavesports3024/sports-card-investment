...
// Replicate the exact manual search query
async function exactManualSearch() {
    console.log('🔍 EXACT MANUAL SEARCH REPLICATION');
    console.log('==================================');
    console.log('Replicating: "Luka Doncic Donruss Optic #177 -(Green, pink, Holo, blue, shock, gold, red, orange, black, 249, fast)"');
    console.log('');
    
    try {
        // Use the exact search query from manual search
        const searchQuery = "Luka Doncic Donruss Optic #177 -(Green, pink, Holo, blue, shock, gold, red, orange, black, 249, fast)";
        
        console.log('📋 SEARCHING WITH EXACT MANUAL QUERY...');
        const rawResults = await search130point(searchQuery, 100);
        ...
        // Search for PSA 9 with same exclusions
        console.log('\n📋 SEARCHING FOR PSA 9 WITH EXCLUSIONS...');
        const psa9Query = "Luka Doncic Donruss Optic #177 PSA 9 -(Green, pink, Holo, blue, shock, gold, red, orange, black, 249, fast)";
        const psa9Results = await search130point(psa9Query, 50);
        ...
        console.log('');
        console.log('Automated Search (Exact Query):');
        ...
        console.error(`❌ Error in exact manual search:`, error.message);
        return { error: error.message };
    }
}

// Run the exact manual search
if (require.main === module) {
    exactManualSearch().catch(console.error);
}

module.exports = { exactManualSearch }; 