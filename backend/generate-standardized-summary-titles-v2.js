...
class StandardizedSummaryTitleGeneratorV2 {
    constructor() {
    ...
    // Extract player name from title (improved)
    extractPlayer(title) {
        ...
        const patterns = [
            ...
            // Handle three-part names like "Shai Gilgeous-Alexander"
            /\b([A-Z][a-z]+)\s+([A-Z][a-z]+)-([A-Z][a-z]+)\b/g
        ];
        ...
        for (const pattern of patterns) {
            ...
            for (const match of matches) {
                ...
                // Additional validation - skip if it looks like a product name
    ...
    async testStandardizedTitles() {
        console.log('🧪 Testing standardized title generation (V2)...\n');
...
// Export for use
module.exports = { StandardizedSummaryTitleGeneratorV2 };

// For testing locally
if (require.main === module) {
    const generator = new StandardizedSummaryTitleGeneratorV2();
