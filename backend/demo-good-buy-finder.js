...
// Configuration
const GOOD_BUYS_FILE = path.join(__dirname, 'data', 'demo_good_buy_opportunities.json');
...
// Mock PSA 10 data for demonstration
const mockPsa10Data = [
  {
    title: "2017 Panini Prizm Patrick Mahomes II RC Light Blue Prizm SP #269 52/199 PSA 10",
    price: { value: "8000.00" },
    soldDate: "2024-01-15",
    itemUrl: "https://example.com/item1"
  },
  {
    title: "2020 Panini Prizm Justin Herbert RC Silver Prizm #280 PSA 10",
    price: { value: "1200.00" },
    soldDate: "2024-01-20",
    itemUrl: "https://example.com/item2"
  },
  {
    title: "2018 Panini Prizm Josh Allen RC Blue Prizm #280 PSA 10",
    price: { value: "950.00" },
    soldDate: "2024-01-25",
    itemUrl: "https://example.com/item3"
  },
  {
    title: "2021 Panini Prizm Trevor Lawrence RC Gold Prizm #280 PSA 10",
    price: { value: "750.00" },
    soldDate: "2024-01-30",
    itemUrl: "https://example.com/item4"
  },
  {
    title: "2019 Panini Prizm Kyler Murray RC Red Prizm #280 PSA 10",
    price: { value: "600.00" },
    soldDate: "2024-02-01",
...
async function findGoodBuys() {
  console.log('🚀 Starting demo good buy analysis...');
  ...
  console.log(`🧪 Using ${mockPsa10Data.length} mock PSA 10 cards...`);
  
  const goodBuys = [];
  
  // Process each card
  for (const card of mockPsa10Data) {
  ...
  if (goodBuys.length > 0) {
    ...
    const results = {
      metadata: {
        ...
        totalProcessed: mockPsa10Data.length,
        goodBuysFound: goodBuys.length,
        note: "This is a demo using mock data"
      },
    ...
    console.log('\n❌ No good buy opportunities found in demo data');
  }
}
