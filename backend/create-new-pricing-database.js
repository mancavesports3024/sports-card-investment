...
class NewPricingDatabase {
    ...
    extractPlayerName(title) {
        ...
        const cardTerms = [
            ...
            'night', 'cosmic stars', 'cosmic', 'all-etch', 'all etch', 'sublime', 'shimmer', 'scripts', 'ref', 'reptilian', 'storm', 'zone', 'sunday', 'pop', 'chasers', 'busters', 'reactive', 'reprint', 'king', 'dallas', 'snake', 'rainbow', 'go hard go', 'go hard go home', 'home'
        ];
    ...
    filterTeamNamesFromPlayer(playerName) {
        ...
        const teamNames = [
            ...
            'refractor', 'x-fractor', 'cracked ice', 'stained glass', 'die-cut', 'die cut',
            'holo', 'holographic', 'prizm', 'chrome', 'base', 'sp', 'ssp', 'short print',
            'super short print', 'parallel', 'insert', 'numbered', 'limited', 'au', 'auto', 'autograph', 'autographs', 'edition', 'sublime', 'shimmer', 'scripts', 'ref', 'reptilian', 'storm', 'zone', 'sunday', 'pop', 'chasers', 'busters', 'reactive', 'reprint', 'king', 'dallas', 'snake', 'rainbow', 'go hard go', 'go hard go home', 'home'
        ];
