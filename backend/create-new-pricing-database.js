...
class NewPricingDatabase {
    ...
    async extractPlayerName(title) {
        ...
        // COMPREHENSIVE FILTERING: Remove all card-related terms, grading info, team names, and sport terms
        // This is the single source of truth for all filtering
        ...
        // Step 2: Split into words and filter out all terms to remove
