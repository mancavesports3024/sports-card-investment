...
class DatabaseDrivenStandardizedTitleGenerator {
    ...
    extractPlayer(title) {
        ...
        const cardTypeTerms = [
            ...
            'chrome', 'refractor', 'draft', 'helmet', 'heroes', 'sapphire', 'optic', 'hit', 'basketball', 'one and one', 'downtown', 'road to uefa euro', 'usa basketball', 'downtown', 'skybox', 'dp', 'light it up', 'disco', 'orange', 'prizm', 'mosaic', 'prospect', 'prospects'
        ];
